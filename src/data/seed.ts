...
const COMPANIES: Company[] = [
  ...
  { n: 'HCA Healthcare', ind: 'Bio / Healthcare', c: 'Nashville, TN' },
  { n: 'Quest Diagnostics', ind: 'Bio / Healthcare', c: null },
  { n: 'eClinicalWorks', ind: 'Bio / Healthcare', c: null },
  { n: 'Viatris', ind: 'Bio / Healthcare', c: null },
  { n: 'QuidelOrtho', ind: 'Bio / Healthcare', c: 'San Diego, CA' },
  { n: 'Otsuka', ind: 'Bio / Healthcare', c: null },
  { n: 'Bio-Techne', ind: 'Bio / Healthcare', c: 'Minneapolis, MN' },
  { n: 'Soleno Therapeutics', ind: 'Bio / Healthcare', c: 'Redwood City, CA' },
